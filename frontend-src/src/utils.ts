...
export const weatherURL =
  'https://assets.msn.com/service/weather/overview?apikey=UhJ4G66OjyLbn9mXARgajXLiLw6V75sHnfpU60aJBB&ocid=weather-peregrine&market=BR&scn=APP_ANON&units=C&wrapodata=false&includemapsmetadata=true&cuthour=true&filterRule=card&includenowcasting=true&nowcastingapi=2&distanceinkm=10&regionDataCount=20&orderby=distance&days=5&pageOcid=anaheim-ntp-peregrine&source=undefined_csr&hours=13&inclup=1&region=br&locale=pt-br&lat=-28.482999801635742&lon=-48.784000396728516&xuxa=123';
